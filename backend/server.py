...
async def create_match(match_data: MatchCreate, current_user: dict = Depends(get_current_user)):
    ...
    match_doc = {
        ...
        "player_a_elo": current_user.get("elo_rating", 500),
        "player_b_elo": opponent.get("elo_rating", 500),
        "player_a_tier": ELOCalculator.get_tier(current_user.get("elo_rating", 500)),
        "player_b_tier": ELOCalculator.get_tier(opponent.get("elo_rating", 500)),
