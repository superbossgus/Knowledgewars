...
const resources = {
  es: {
    ...
    lobby: {
      ...
      custom_placeholder: 'Escribe cualquier tema... ej: Michael Jackson',
      examples: 'Ejemplos',
      playing_topic: 'Jugarás sobre',
      enter_topic: 'Por favor ingresa o selecciona un tema',
      ...
      matchmaking_tier: 'Solo verás jugadores de tu mismo tier para partidas competitivas',
      your_tier: 'Tu tier',
      all_ranks: 'Todos los Rangos',
      my_rank_only: 'Solo Mi Rango',
      search_player: 'Buscar jugador por nombre...',
      search_found: '{{count}} jugador(es) encontrado(s)',
      search_not_found: 'No se encontraron jugadores',
      friendly_match_info: 'Mostrando jugadores de todos los rangos. Las partidas amistosas no afectan tu ELO competitivo.'
    },
    topics: {
